...
record _Decider<C, Si, So, Ei, Eo>(
    ...
    <Cn> _Decider<Cn, Si, So, Ei, Eo> contraMapOnCommand(Function<? super Cn, ? extends C> f) {
        return new _Decider<>(
    ...
    <Ein, Eon> _Decider<C, Si, So, Ein, Eon> dimapOnEvent(Function<? super Ein, ? extends Ei> fl, Function<? super Eo, ? extends Eon> fr) {
        return new _Decider<>(
    ...
    <Sin, Son> _Decider<C, Sin, Son, Ei, Eo> dimapOnState(Function<? super Sin, ? extends Si> fl, Function<? super So, ? extends Son> fr) {
        return new _Decider<>(
    ...
    <Son> _Decider<C, Si, Son, Ei, Eo> applyOnState(_Decider<? super C, ? super Si, ? extends Function<? super So, ? extends Son>, ? super Ei, ? extends Eo> decider2) {
        return new _Decider<>(
    ...
    <Son> _Decider<C, Si, Pair<So, Son>, Ei, Eo> productOnState(_Decider<? super C, ? super Si, ? extends Son, ? super Ei, ? extends Eo> decider2) {
        return this.applyOnState(decider2.dimapOnState((it) -> it, (b) -> ((a) -> new Pair<>(a, b))));
    }


    static <C_SUPER, Ei_SUPER, Eo_SUPER, Si1, So1, Si2, So2, C1 extends C_SUPER, C2 extends C_SUPER, Ei1 extends Ei_SUPER, Eo1 extends Eo_SUPER, Ei2 extends Ei_SUPER, Eo2 extends Eo_SUPER> _Decider<C_SUPER, Pair<Si1, Si2>, Pair<So1, So2>, Ei_SUPER, Eo_SUPER> combineIt(
